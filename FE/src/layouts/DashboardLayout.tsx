...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex  min-h-screen bg-background ">
      ...
      {sidebarOpen && (
        <div
          className="fixed inset-0 bg-foreground/20 z-30 xl:hidden"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed xl:sticky top-0 left-0 z-40 h-screen w-64 bg-sidebar flex flex-col transition-transform duration-200 ${sidebarOpen ? "translate-x-0" : "-translate-x-full xl:translate-x-0"}`}
      >
